...
Updated to use port 8090 to avoid conflicts
"""
import json
import time
import random
...
if __name__ == '__main__':
    ...
    # Changed to port 8090 to avoid conflict with WebSocket
    PORT = 8090
    server = HTTPServer(('localhost', PORT), LOLAHandler)
    print(f'[LOLA Server] Starting on http://localhost:{PORT}')
